defmodule TheEstateIndexWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(TheEstateIndexWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(TheEstateIndexWeb.Gettext, "errors", msg, opts)
    end
  end
